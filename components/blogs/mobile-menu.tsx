import { MobileMenuCloseButton } from "@/components/blogs/mobile-menu-close-button";
          ...
          >
            <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
              <Transition.Child
                ...
                leaveTo="opacity-0"
              >
                <MobileMenuCloseButton setSidebarOpen={setSidebarOpen} />
              </Transition.Child>
              ...
              <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
                <a href="components#" className="group block flex-shrink-0">
