...
export function MobileNavigation(props: any) {
  return (
    <Popover {...props}>
      <Popover.Button className="group flex items-center rounded-full bg-white/90 px-4 py-2 text-sm font-medium shadow-lg ring-1 backdrop-blur bg-dark-blue-500 text-gray-200 ring-white/10 hover:ring-white/20">
        Menu
