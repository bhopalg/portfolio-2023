...
One of the cool features of MDX with can use React components in our Markdown files. To do this, we need to create a `components` folder in the root of our project. Inside this folder, we will create a `layout.tsx` file, which will be our layout component.
