...
export default function AWSIcon(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300.7 179.8" width="2500" height="1495" {...props}>
      <path
        fill="currentColor"
